...
ready(function() {
    ...
    Vizabi.Component.extend('donut', {
        ...
        update: function(){
            ...
            var t = this.model.time.value;
            this.keys = this.model.marker.getKeys();
            this.values = this.model.marker.getValues({ time: t}, ["geo"]);
        ...
        redraw: function() {
            ...
            var data = utils.clone(this.keys);
            
            data.forEach(function(d){
            	d.pop = _this.values.axis[d.geo];
            	d.color = _this.values.color[d.geo];
            	d.label = _this.values.label[d.geo];
            });
